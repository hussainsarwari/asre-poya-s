...
export default function section1() {
  ...
  return (
    <div className="flex flex-col-reverse items-center mx-auto lg:flex-row lg:h-[550px] ">
      ...
      <div className="">
        ...
        <div className="bg-[#1E1E2B] hidden lg:flex w-[619px] h-[91px] py-7 px-10 rounded-2xl  flex-row-reverse items-center ">
          <div className="flex flex-row-reverse items-center justify-center ">
            ...
            <div>
              <h2 className="font-bold text-[12px] text-white">
                {t("do_you_need_consultation")}
              </h2>
              <p className="text-[#FFFFFFCC] text-[8px] mt-1">
                {t("we_are_here")}
              </p>
            </div>
          </div>
          ...
          >
            <input
              ...
              className="text-white border border-[#FFFFFF66]  w-[120px] h-7 rounded-lg py-2 px-3 text-[8px]"
            />
            <input
              type="text"
              name="description"
      ...
      <div className="w-[370px] relative flex justify-center" dir="rtl">
        {/* section 2 */}
        <div className="mb-30">
          ...
          <Image
            src={vector}
            alt="vector"
            className="lg:mr-[190.9px] mr-40 mt-5 w-[183px]  lg:w-[208px]"
          />
        ...
        <div className="h-[70px] flex mt-[166px] absolute md:top-[660px] top-[500px] lg:top-[260px]  ">
          <div className="border-r flex items-center justify-center px-3.5 border-[#1E1E2B33]">
            ...
            <h1 className="text-[#1E1E2B99]">{t("active_clients")}</h1>
          </div>
          <div className="border-r flex items-center justify-center px-3.5 border-[#1E1E2B33]">
