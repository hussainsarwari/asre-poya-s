    ...
    <div dir={dir=="rtl"?"rtl":"ltr"} className="mt-20 w-[350px] md:w-[616px] lg:w-[1056px]">
      ...
      <div className="grid md:grid-cols-2 md:grid-rows-2 grid-cols-1 grid-rows-4 mt-[60px] gap-10">
        <div className="flex flex-col lg:w-[503.9998779296875px] md:w-[324px] lg:flex-row-reverse  w-[360px]  items-end">
          ...
          <div className="flex flex-col items-end ">
            <h4 className="text-[20px] font-bold text-[#1E1E2B] w-40"  dir={dir=="ltr"?"rtl":"ltr"}>{t("product_software_version_box1_title")}</h4>
            <p  dir={dir=="ltr"?"rtl":"ltr"} className=" text-[#1E1E2B99] text-[14px] my-4">{t("product_software_version_box1_paragraph")}</p>
        ...
        <div className="flex flex-col lg:w-[503.9998779296875px] md:w-[324px] lg:flex-row-reverse  w-[350px] items-end">
          ...
          <div className="flex flex-col items-end ">
            <h4 className="text-[20px] font-bold text-[#1E1E2B] w-40"  dir={dir=="ltr"?"rtl":"ltr"}>{t("product_software_version_box2_title")}</h4>
            <p  dir={dir=="ltr"?"rtl":"ltr"} className=" text-[#1E1E2B99] text-[14px] my-4">{t("product_software_version_box2_paragraph")}</p>
        ...
        <div className="flex flex-col lg:w-[503.9998779296875px] md:w-[324px] lg:flex-row-reverse  w-[350px] items-end">
          ...
          <div className="flex flex-col items-end ">
            <h4 className="text-[20px] font-bold text-[#1E1E2B] w-40"  dir={dir=="ltr"?"rtl":"ltr"}>{t("product_software_version_box3_title")}</h4>
            <p  dir={dir=="ltr"?"rtl":"ltr"} className=" text-[#1E1E2B99] text-[14px] my-4">{t("product_software_version_box3_paragraph")}</p>
        ...
        <div className="flex flex-col lg:w-[503.9998779296875px] md:w-[324px] lg:flex-row-reverse  w-[350px] items-end">
          ...
          <div className="flex flex-col items-end ">
            <h4 className="text-[20px] font-bold text-[#1E1E2B] w-40"  dir={dir=="ltr"?"rtl":"ltr"}>{t("product_software_version_box4_title")}</h4>
            <p  dir={dir=="ltr"?"rtl":"ltr"} className=" text-[#1E1E2B99] text-[14px] my-4">{t("product_software_version_box4_paragraph")}</p>
