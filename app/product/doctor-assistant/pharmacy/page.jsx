...
export default function clinic() {
  return (
    ...
    <div className="lg:w-[1056px] md:w-[616px] w-[360px] m-auto flex flex-col">
      <Section1 SectionName='pharmacy'/>
      <Main_feature_software SectionName='pharmacy'/>
      <Why_choose_us SectionName='pharmacy'/>     
      <Software_versions SectionName='pharmacy'/>
      <Price_plane SectionName='pharmacy'/>
      <Client_opinion SectionName='pharmacy'/>
      <FAQ SectionName='pharmacy'/>
    </div>
    </>
  );
}