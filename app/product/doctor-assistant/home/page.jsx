...
export default function Home() {
  return (
    <div className="lg:w-[1056px] md:w-[616px] w-[360px] m-auto flex flex-col">
      <Main_feature_software SectionName='home'/>
      <Why_choose_us SectionName='home'/>     
      <Software_versions SectionName='home'/>
      <Price_plane SectionName='home'/>
      <Client_opinion SectionName='home'/>
      <FAQ SectionName='home'/>
    </div>
  );
}