...
export default function ContactUs() {
  ...
  return (
    <div className="flex flex-col gap-8  mx-auto my-[142px]  w-[70%]" dir="rtl">
      {/* عنوان */}
      ...
      <div className="flex flex-col-reverse lg:flex-row-reverse gap-8 relative bg-[#1E1E2B08] mt-9 p-6 rounded-2xl lg:h-[340px] lg:w-[1056px]">
        
        {/* Google Map */}
        <div className="w-full sm:w-[18em] lg:w-[20em] xl:w-[292px] xl:h-[292px]  aspect-square border border-[#CBCBCB] rounded-sm overflow-hidden  m-auto lg:mx-0">
          <iframe
          ...
          <div className="flex flex-col top-[126px]">
            ...
            <div className="flex items-center gap-2 h-14">
              <Image src={location} alt="location" className="w-4" />
                ...
                <h3 className="font-semibold text-black text-[16px]">{t("location")}:</h3>
                <p className="text-[#1E1E2B99] text-[16px]">Mazar-e-Sharif, Afghanistan</p>
            ...
            <div className="flex items-center gap-2 h-14">
              <Image src={call} alt="phone" width={16} height={16} />
                ...
                <h3 className="font-semibold text-black text-[16px]">{t("call")}:</h3>
                <p className="text-[#1E1E2B99] text-[16px]">+9377777777777</p>
            ...
            <div className="flex items-center gap-2 h-14">
              <Image src={sms} alt="email" className="w-5"  />
                ...
                <h3 className="font-semibold text-black text-[16px]">{t("email")}:</h3>
                <p className="text-[#1E1E2B99] text-[16px]">email@asrepoya.com</p>
