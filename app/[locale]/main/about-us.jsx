    ...
    >
      ...
      <div className="m-auto lg:w-[1056px] relative z-10 md:w-[616px] w-[346px] overflow-visible">
        ...
        >
          ...
          <div className="lg:w-[516px] lg:h-[86px] rounded-xl bg-white border border-[#1E1E2B1A] p-3 shadow-lg shadow-[#00000026]">
        ...
        >
          ...
          >
            ...
            <p className="text-[#1E1E2B99]  text-[8px] lg:text-[14px]">
